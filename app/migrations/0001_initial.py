# Generated by Django 5.0.7 on 2025-09-10 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'مدير النظام'), ('user', 'مستخدم عادي')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoices', to='app.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
