...
import { Image, StyleSheet, Text, View, ScrollView, Alert, TouchableOpacity, Animated } from 'react-native';
                ...
                <Button
                  ...
                  onPress={async () => {
                    ...
                    try {
                      ...
                      Alert.alert('تم الإرسال', 'تم إرسال رمز التحقق عبر واتساب');
                    } catch (err: any) {
                      Alert.alert('خطأ', err?.response?.data?.detail || 'فشل إرسال الرمز');
                    } finally {
                    ...
                    <Button
                      ...
                      onPress={async () => {
                        ...
                        try {
                          ...
                          Alert.alert('نجح التحقق', 'تم التحقق من الرقم بنجاح');
                        } catch (err: any) {
                          Alert.alert('خطأ', err?.response?.data?.detail || 'رمز التحقق غير صحيح');
                        } finally {
              ...
              <Button
                ...
                onPress={async () => {
                  ...
                  try {
                    ...
                    Alert.alert('تم التسجيل', 'تم تسجيل الشركة بنجاح، يمكنك تسجيل الدخول الآن');
                    // auto-fill login
                    setUsername(adminUsername.trim());
                    setPassword(adminPassword);
                    setActiveTab('login');
                  } catch (err: any) {
                    Alert.alert('خطأ', err?.response?.data?.detail || 'فشل تسجيل الشركة');
                  } finally {
              ...
              <View style={styles.fieldGroup}>
                ...
                {resetOtpSession ? (
                  <>
                    ...
                    />
                    {resetOtpVerified ? <SoftBadge label="الرقم موثق" variant="info" /> : null}
                  </>
                ) : null}
              ...
              <Button
                ...
                onPress={async () => {
                  ...
                  try {
                    ...
                    Alert.alert('تم التحديث', 'تم تحديث كلمة المرور بنجاح');
                    setActiveTab('login');
                    ...
                    Alert.alert('خطأ', err?.response?.data?.detail || 'فشل تحديث كلمة المرور');
                  } finally {
